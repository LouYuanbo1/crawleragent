...
func (cs *rodService[C, D]) ScrollStrategy(ctx context.Context, param *param.Scroll) error {
...
func (cs *rodService[C, D]) ClickStrategy(ctx context.Context, param *param.Click) error {
